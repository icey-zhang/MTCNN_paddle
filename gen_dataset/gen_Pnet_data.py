...
import os, sys
sys.path.append('.')
# sys.path.append('/home/aistudio/MTCNN-master')
import cv2
import os
import numpy as np
...
for mode in ['train','val']:
    ...
    pos_save_dir = Root_path + "/{}/{}/positive".format(mode,net_size)
    part_save_dir = Root_path + "/{}/{}/part".format(mode,net_size)
    neg_save_dir = Root_path + "/{}/{}/negative".format(mode,net_size)

    pos_txt = os.path.join('annotations', 'pos_{}_{}.txt'.format(net_size, mode))
    part_txt = os.path.join('annotations', 'part_{}_{}.txt'.format(net_size, mode))
    neg_txt = os.path.join('annotations', 'neg_{}_{}.txt'.format(net_size, mode))
