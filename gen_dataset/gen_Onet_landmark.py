...
for mode in ['train','val']:
    # mode = 'train'
    prefix = ''
    data_dir = Root_path + '/FacePoint/'
    if mode =='train':
        anno_file = Root_path + '/FacePoint/' + '/{}ImageList.txt'.format(mode)
    else:
        anno_file = Root_path + '/FacePoint/' + '/testImageList.txt'
    # data_dir = './data/FacePoint'
    # anno_file = './data/FacePoint/{}ImageList.txt'.format(mode)
    save_dir = Root_path + '/{}/'.format(mode)
    size = 48
    image_id = 0
    ...
    for annotation in annotations:
        ...
        im_path = data_dir + annotation[0].replace("\\","//")
        #print(im_path)
